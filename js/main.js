!function(r) {
    ...
    function s() {
        ...
        var o = r(".ajax-page-load").each(function() {
            if (o = r(this).attr("href"),
            location.hash == location.hash.split("/")[0] + "/" + o.substr(0, o.length - 5)) {
        ...
        r(document).on("click", "#ajax-page-close-button", function(e) {
            ...
            setTimeout(function() {
                r("#page-ajax-loaded.closed").html(""),
                a.hide()
            }, 500),
            ...
            if (!e.isDefaultPrevented()) {
                return r.ajax({
                    ...
                    success: function(e) {
                        ...
                        a && t && (r("#contact_form").find(".messages").html(o),
    ...
    r(window).on("load", function() {
        ...
        (a = r(991 < e ? ".page-container" : ".site-main")).addClass("animated " + t),
    ...
    r(document).on("ready", function() {
        ...
        r("body").on("mousemove", function(e) {
            ...
            if (r(".page-container").hasClass("bg-move-effect"))
                var s = r(".home-photo .hp-inner:not(.without-move), .lm-animated-bg");
            else
                s = r(".home-photo .hp-inner:not(.without-move)");
        ...
        r("body").append('<div id="page-ajax-loaded" class="page-portfolio-loaded animated fadeInLeft" style="display: none"><div class="preloader-portfolio"><div class="preloader-animation"><div class="preloader-spinner"></div></div></div></div>'),
        s(),
        r(".sidebar-toggle").on("click", function() {
            r("#blog-sidebar").toggleClass("open"),
